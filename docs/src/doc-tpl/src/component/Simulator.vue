<template>
  <div :class="['kit-doc-simulator', { 'kit-doc-simulator-fixed': isFixed }]">
    <div class="kit-doc-simulator__nav">
      <div class="kit-doc-simulator__browser">
        <button class="kit-doc-simulator__browser-btn kit-doc-simulator__browser-back" v-html="icons.back"></button>
        <button class="kit-doc-simulator__browser-btn kit-doc-simulator__browser-forward" v-html="icons.forward"></button>
        <div class="kit-doc-simulator__browser-url">{{ iframeHostName }}</div>
      </div>
      <div class="kit-doc-simulator__reload" @click="reloadIframe"></div>
    </div>
...
.kit-doc-simulator {
  ...
  @media (max-width: 1300px) {
    width: $kit-doc-simulator-small-width;
    min-width: $kit-doc-simulator-small-width;
  }
